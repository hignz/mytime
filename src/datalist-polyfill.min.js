...
let u=window.document; var e=window.navigator.userAgent;

// Feature detection

var t="list"in u.createElement("input")&&Boolean(u.createElement("datalist")&&window.HTMLDataListElement);
...
var s=Boolean(e.match(/Trident\/[6-7]\./)); var d=Boolean(e.indexOf("Edge/")!==-1);
...
var c=13; var v=27; var y=38; var f=40;
...
var l=["text","email","number","search","tel","url"];

// Classes for elements

var o="polyfilled"; var m="polyfilling";
      ...
      if (
        (e.forEach(function(e) {
          ...
          for (var t = 0; t < e.addedNodes.length; ++t)
            'datalist' === e.target.tagName.toLowerCase() && (a = e.target);
        }),
        a)
      ) {
...
var             r = a.getElementsByClassName(m)[0] || k(t, a);
          ...
          if (e.keyCode !== v && e.keyCode !== c && ('' !== t.value || i) && void 0 !== r) {
            // ... prepare the options
L(a,t).length>0&&(n=!0);let o=0; var l=r.options.length-1;
            // ... preselect best fitting index
            p
              ? (r.selectedIndex = 0)
              : i &&
                'number' !== t.getAttribute('type') &&
                ((r.selectedIndex = e.keyCode === y ? l : 0),
    ...
    h = function(e) {
      var t = e.target,
        a = t.list;
      if (t.matches('input[list]') && t.matches('.' + o) && a) {
        // Query for related option - and escaping the value as doublequotes wouldn't work
let i=a.querySelector(`option[value="${t.value.replace(/\\([\s\S])|(")/g,"\\$1$2")}"]`);i&&i.dataset.originalvalue&&(t.value=i.dataset.originalvalue)}},w=function(e,t){let a=e.value.toLowerCase(); var i=t.toLowerCase(); var n=e.getAttribute("label"); var r=e.text.toLowerCase();
      /*
...
let i=t.list.options[0];i.value=i.value}
...
t==="focusin"?(e.addEventListener("keyup",n),e.addEventListener("focusout",E,!0),(s||d)&&e.addEventListener("input",h)):t==="blur"&&(e.removeEventListener("keyup",n),e.removeEventListener("focusout",E,!0),(s||d)&&e.removeEventListener("input",h)),
  ...
  if (
    ...
    var L = function(e, n) {
        void 0 !== r && r.disconnect();
        var // Creating the select if there's no instance so far (e.g. because of that it hasn't been handled or it has been dynamically inserted)
          t = e.getElementsByClassName(m)[0] || k(n, e),
          o = n.value,
...
n.getAttribute("type")==="email"&&n.getAttribute("multiple")!==null&&(o=o.substring(o.lastIndexOf(",")+1)),
          // Create an array out of the options list
          Array.prototype.slice
            .call(e.querySelectorAll('option:not(:disabled)'))
            .sort(function(e, t) {
              var a = e.value,
                i = t.value;
              ...
              return (
                'url' === n.getAttribute('type') &&
                  ((a = a.replace(/(^\w+:|^)\/\//, '')), (i = i.replace(/(^\w+:|^)\/\//, ''))),
                a.localeCompare(i)
              );
            })
            .forEach(function(e) {
        ...
        return (
          ...
          (e.getElementsByClassName('ie9_fix')[0] || e).appendChild(s),
          void 0 !== r && r.observe(e, { childList: !0 }),
          t.options
        );
      },
      k = function(e, t) {
...
var i=window.getComputedStyle(e); var n=u.createElement("select");
          ...
          if (
            ...
            p || n.setAttribute('aria-multiselectable', 'false'),
            'block' === i.getPropertyValue('display'))
          )
            n.style.marginTop = '-' + i.getPropertyValue('margin-bottom');
          else {
            var r = 'rtl' === i.getPropertyValue('direction') ? 'right' : 'left';
            n.style.setProperty(
              'margin-' + r,
              '-' + (a[0].width + parseFloat(i.getPropertyValue('margin-' + r))) + 'px'
            ),
              (n.style.marginTop = parseInt(a[0].height + (e.offsetTop - t.offsetTop), 10) + 'px');
          }
          // Set the polyfilling selects border-radius equally to the one by the polyfilled input
          if (
            ((n.style.borderRadius = i.getPropertyValue('border-radius')),
            (n.style.minWidth = a[0].width + 'px'),
            p)
          ) {
          ...
          return (
            ...
            p ? n.addEventListener('change', x) : n.addEventListener('click', x),
            n.addEventListener('blur', x),
            n.addEventListener('keydown', x),
            n.addEventListener('keypress', A),
            n
          );
        }
      },
...
var r="keydown"===n&&e.keyCode!==c&&e.keyCode!==v; var o;
          ...
          if (
            ...
            (i.value =
              // Using .getAttribute here for IE9 purpose - elsewhere it wouldn't return the newer HTML5 values correctly
i.getAttribute("type")==="email"&&i.getAttribute("multiple")!==null&&(o=i.value.lastIndexOf(","))>-1?`${i.value.slice(0,o)},${t.value}`:t.value,
              // Dispatch the input event on the related input[list]
              T(i),
...
e.key!=="Tab"&&i.focus(),
      ...
      T = function(e) {
        ...
        'function' == typeof Event
          ...
          : (t = u.createEvent('Event')).initEvent('input', !0, !1),
          e.dispatchEvent(t);
      },
      N = function(e, t) {
        e ? t.removeAttribute('hidden') : t.setAttributeNode(u.createAttribute('hidden')),
    ...
    (B = window.HTMLInputElement) &&
      B.prototype &&
      void 0 === B.prototype.list &&
      Object.defineProperty(B.prototype, 'list', {
        get: function() {
          /*
					...
					*/
let e=u.getElementById(this.getAttribute("list"));returntypeof this=="object"&&this instanceof B&&e&&e.matches("datalist")?e:null}}),(
      // Options property / https://developer.mozilla.org/en/docs/Web/API/HTMLDataListElement
      (O = window.HTMLElement) &&
        O.prototype &&
        void 0 === O.prototype.options &&
        Object.defineProperty(O.prototype, 'options', {
          get: function() {
            return 'object' == typeof this && this instanceof O
